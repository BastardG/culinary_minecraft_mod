...
public class FootTubEntityRenderer implements BlockEntityRenderer<FootTubEntity> {

    public FootTubEntityRenderer(BlockEntityRendererProvider.Context ctx) {}

    @Override
    public boolean shouldRender(FootTubEntity blockEntity, Vec3 p_173569_) {
        return true;
    }

    @Override
    public boolean shouldRenderOffScreen(FootTubEntity blockEntity) {
        return true;
    }
